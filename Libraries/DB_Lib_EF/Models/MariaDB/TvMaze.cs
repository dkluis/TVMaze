...
public partial class TvMaze : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Movie>(entity =>
        {
            ...
            entity.HasOne(d => d.MediaTypeNavigation).WithMany().HasPrincipalKey(p => p.MediaType1).HasForeignKey(d => d.MediaType).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("Movies_FK");
        });
